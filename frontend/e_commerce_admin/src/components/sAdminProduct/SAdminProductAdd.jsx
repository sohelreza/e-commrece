...
class SAdminProductAdd extends Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit(e) {
    ...
    fileData.append("thumbnailImage", file);
    ...
    sAdminProductApi
      .sAdminAddProduct(fileData, formattedToken)
      .then((response) => {
        this.setState({
          submitting: false,
          errorStatus: null,
  ...
  render() {
    ...
    return (
      <>
        <p className="h1 m-4">Add Product</p>

        {submitted && errorStatus === 400 && (
          <span className="validation-error mt-2">Adding Product Failed</span>
        )}
        ...
        <form onSubmit={this.handleSubmit.bind(this)}>
          ...
          {submitting ? (
            ...
            <button
              type="submit"
              className="btn btn-primary create-button mb-5"
            >
              Submit
            </button>
          )}
...
const connectedSAdminProductAdd = connect(
  mapStateToProps,
  mapDispatchToProps
)(SAdminProductAdd);

export { connectedSAdminProductAdd as SAdminProductAdd };
